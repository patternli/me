...
{% assign stories = site.project-stories | where: "title", list.title %}

{{ stories.list[0].title }}

{{ site.project-stories[0].title }}

{% include patterns/card/card.md content=stories %}
